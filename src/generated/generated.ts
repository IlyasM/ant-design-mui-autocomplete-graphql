...
export type PositionsQuery = { __typename?: 'Query', applicantIndividualCompanyPositions?: { __typename?: 'ApplicantIndividualCompanyPositionPaginator', data: Array<{ __typename?: 'ApplicantIndividualCompanyPosition', name: string, id: string }> } | null };

export type RelationsQueryVariables = Exact<{ [key: string]: never; }>;


export type RelationsQuery = { __typename?: 'Query', applicantIndividualCompanyRelations?: { __typename?: 'ApplicantIndividualCompanyRelationPaginator', data: Array<{ __typename?: 'ApplicantIndividualCompanyRelation', name: string, id: string }> } | null };
...
export const usePositionsQuery = <
      TData = PositionsQuery,
      TError = unknown
    >(
      variables?: PositionsQueryVariables,
      options?: UseQueryOptions<PositionsQuery, TError, TData>
    ) =>
    useQuery<PositionsQuery, TError, TData>(
      variables === undefined ? ['Positions'] : ['Positions', variables],
      useFetchData<PositionsQuery, PositionsQueryVariables>(PositionsDocument).bind(null, variables),
      options
    );
...
export const useRelationsQuery = <
      TData = RelationsQuery,
      TError = unknown
    >(
      variables?: RelationsQueryVariables,
      options?: UseQueryOptions<RelationsQuery, TError, TData>
    ) =>
    useQuery<RelationsQuery, TError, TData>(
      variables === undefined ? ['Relations'] : ['Relations', variables],
      useFetchData<RelationsQuery, RelationsQueryVariables>(RelationsDocument).bind(null, variables),
      options
    );